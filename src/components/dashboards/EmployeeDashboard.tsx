...
import { CheckSquare, Clock, Send, Trophy, ArrowRight } from "lucide-react";
...
export function EmployeeDashboard() {
  ...
  const statCards = [
    { label: "Assigned Tasks", value: stats?.total || 0, icon: CheckSquare, accent: "text-primary", bg: "bg-primary/10" },
    { label: "In Progress", value: stats?.pending || 0, icon: Clock, accent: "text-warning", bg: "bg-warning/10" },
    { label: "Submitted", value: stats?.submitted || 0, icon: Send, accent: "text-info", bg: "bg-info/10" },
    { label: "Completed", value: stats?.completed || 0, icon: Trophy, accent: "text-success", bg: "bg-success/10" },
  ];
